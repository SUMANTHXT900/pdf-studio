...
| Frontend unit tests (`npm test`)                              | 289 passing (toolUsage 12, updateManager +5, imageSharding 15, downloadNaming 10, import worker-fallback, thumbnail encode-concurrency, scan detect-only, single-getPage thumbnails, PNG→JPEG import) |
